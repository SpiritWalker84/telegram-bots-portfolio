...
В папке `examples/` уже есть готовые примеры файлов:
...
**Примеры для сертификатов:**
- `examples/список сертификатов.csv` — пример данных для сертификатов
- `examples/certificate.html` — HTML‑шаблон сертификата (A4 landscape)
